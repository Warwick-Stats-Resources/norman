...
```{r eval=history_exists, fig.width=5, fig.height=7, out.height='5in', fig.align='left'}
...
```{r eval=history_exists, fig.width=5, fig.height=7, out.height='5in', fig.align='right'}
# Keep as duplicate history_boxplot for now.
# Will replace with different plot when implemented
norman::history_boxplot(recent_history)
```
